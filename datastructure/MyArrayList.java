...
public class MyArrayList {
    ...
    public static void main(String[] args) {
        ...
        /*
         * ArrayList<String> arrayList = new ArrayList<>(); arrayList.add("hello");
         * arrayList.add("hell"); arrayList.add("hel"); arrayList.add("he"); arrayList.add("h");
         * arrayList.add("w"); arrayList.add("wo"); arrayList.add("wor"); arrayList.add("worl");
         * arrayList.add("world"); System.out.println(arrayList.indexOf(" "));
         */
