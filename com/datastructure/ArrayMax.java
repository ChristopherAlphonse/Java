...
public class ArrayMax {
    ...
    public static void main(String[] args) {
        ...
        logger.log(Level.INFO, () -> " The max Range value: " + findMaxRange(n, startRange, endRange));
    ...
    /*
     * for num of index of n, if index of n is greater than the previous value that is stored in result,
     * update result to the value of the current index of n
     */
